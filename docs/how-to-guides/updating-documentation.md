...
The website is generated using [Material for MkDocs](https://squidfunk.github.io/mkdocs-material) and can be viewed at [homelab.dabvastur-lab.com](https://homelab.dabvastur-lab.com).
...
<!-- - Find the TXT record for `homelab.dabvastur-lab.com` and switch the `ownerID` between `homelab` and `horus` -->
